    ...
    if (tmpCorns.length == 6 || tmpCorns.length == 7) {
        ...
        if (!months.equals("*") && !months.equals("?")) {
            ...
            if (months.contains("/")) {
                ...
                sBuffer.append("从").append(months.split("/")[0]).append("月开始").append(",每")
        ...
        if (!days.equals("?") && !days.equals("*")) {
            ...
            if (days.contains("/")) {
                ...
                sBuffer.append("每月从第").append(days.split("/")[0]).append("天开始").append(",每")
            ...
            } else if ("W".equals(days)) { // 处理W 表示最近的工作日
                sBuffer.append("每月最近工作日的");
...
public static String judgeWeek(String weekNum) {
    ...
    return weekName != null && !weekName.isEmpty() ? weekName : String.valueOf(weekNum);
...
public enum WeekEnum {
    ...
    SUNDAY("1", "星期天", "Sunday "), MONDAY("2", "星期一", "Monday "), TUESDAY("3", "星期二", "Tuesday "), WEDNESDAY("4",

            "星期三", "Wednesday "),
    THURSDAY("5", "星期四",

            "Thursday "),
    FRIDAY("6", "星期五", "Friday "), SATURDAY("7", "星期六", "Saturday ");
